...
export const PERMISSIONS = Object.freeze({
  owner: ['*'],
  manager: ['dashboard:view', 'tables:view', 'orders:*', 'kds:view', 'billing:*', 'payments:*', 'receivables:*', 'deliveries:*', 'whatsapp:*', 'cash:*', 'payroll:*', 'catalog:*', 'inventory:*', 'clients:*', 'reports:view', 'audit:view', 'terminal:view'],
  cashier: ['dashboard:view', 'tables:view', 'orders:view', 'orders:create', 'orders:charge', 'billing:view', 'billing:create', 'payments:create', 'receivables:*', 'deliveries:*', 'whatsapp:*', 'cash:*', 'catalog:view', 'inventory:*', 'clients:*', 'terminal:view'],
